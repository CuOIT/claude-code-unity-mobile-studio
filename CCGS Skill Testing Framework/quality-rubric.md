...
**Agents**: unity-specialist, unity-ui-specialist, unity-shader-specialist, unity-dots-specialist, unity-addressables-specialist,
...
| **E2 — File routing** | Routes file types to the correct sub-specialist (e.g., `.shadergraph` → unity-shader-specialist, not unity-specialist) |
| **E3 — Engine-specific patterns** | Enforces Unity idioms (e.g., C# attribute exports [SerializeField], async Addressables loading, URP best practices) |
