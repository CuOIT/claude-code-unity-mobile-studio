...
**Input**: "Now that the event schema is designed, write the C# code to fire these events in our Unity tutorial scene."
**Expected behavior**:
- Does not produce implementation code outside its analytics domain
