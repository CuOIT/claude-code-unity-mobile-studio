...
- TD-ENGINE-RISK assessment for specific engine versions (e.g., Unity 6.3 LTS post-cutoff APIs) is not covered — deferred to engine-specialist integration tests.
