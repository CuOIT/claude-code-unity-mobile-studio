...
rules, and coordination protocols. It is optimized for mobile game
development on Unity 6 LTS — with a dedicated Unity specialist and four
sub-specialists for the major Unity subsystems. All design agents and
templates are grounded in established game design theory (MDA Framework,
Self-Determination Theory, Flow State, Bartle Player Types).
...
1. **Set up the engine** — Run `/setup-engine [engine] [version]`
   (e.g., `/setup-engine unity 6.3`) — also creates technical preferences
