...
| PC (Screen Reader) | JAWS / NVDA / Windows Narrator | [Menu navigation announcements] | Not Started | Requires UI elements to expose accessible names and roles via platform UI layer. Unity Accessibility (a11y) packages cover this for supported UI Toolkit elements. Verify against Unity docs. |
