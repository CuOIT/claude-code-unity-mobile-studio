...
- Is the proposed audio middleware integration idiomatic for Unity? (e.g., Audio Mixer, Wwise, FMOD; prefer Unity Audio Mixer or Addressable-packed clips on mobile)
